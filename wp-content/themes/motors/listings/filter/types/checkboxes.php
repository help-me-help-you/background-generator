...
if (!empty($checkboxes)) {
    foreach ($checkboxes as $checkbox) {
        ...
        <div
            ...
            <a class="title <?php echo ($listing_rows_numbers_default_expanded == 'false') ? 'collapsed':''?> " data-toggle="collapse" href="#accordion-<?php echo esc_attr($checkbox['slug']); ?>"
	            aria-expanded="<?php echo $listing_rows_numbers_default_expanded?>">
                <h5><?php esc_html_e($checkbox['single_name'], 'motors'); ?></h5>
                <span class="minus"></span>
            </a>
            <div class="stm-accordion-content">
                <div class="collapse content <?php echo ($listing_rows_numbers_default_expanded == 'true') ? 'in':''?>" id="accordion-<?php echo esc_attr($checkbox['slug']); ?>">
