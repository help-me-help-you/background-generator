        ...
        <?php foreach ($filter_links as $filter_link) :
            ...
            if (!empty($options[$slug])) :
                ...
                if (!empty($filter_links_cats)): ?>
                    ...
                    <div class="stm-accordion-single-unit" id="stm-filter-link-<?php echo $filter_link['slug']?>">
                        <a class="title <?php echo ($filter_links_default_expanded == 'false') ? 'collapsed':''?> " data-toggle="collapse"
                           href="#<?php echo esc_attr($filter_link['slug']); ?>" aria-expanded="<?php echo $filter_links_default_expanded?>">
                            <h5><?php printf(esc_html__('%s', 'motors'), $filter_link['single_name']); ?></h5>
                            <span class="minus"></span>
                        </a>

                        <div class="stm-accordion-content">
                            <div class="collapsed collapse content <?php echo ($filter_links_default_expanded == 'true') ? 'in':''?> "
