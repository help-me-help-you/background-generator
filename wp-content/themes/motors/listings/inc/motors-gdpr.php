...
function motors_gdpr_checkbox_shcode() {
    return '<div class="motors-gdpr" style="margin: 20px 0;"><label><input type="checkbox" name="motors-gdpr-agree" value="agree" data-need="true" required />' . esc_html__('I agree with storaging of my data by this website.', 'motors') . '</label></div>';
}
