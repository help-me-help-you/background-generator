...
class PricePerHour
{
    ...
    {
        add_action('add_meta_boxes', array(get_class(), 'addPricePerHourMetaBox'));
    ...
    public static function addPricePerHourMetaBox() {
        add_meta_box(
            'price_per_hour'
            ,__( 'Price Per Hour', 'motors' )
            ,array(get_class(), 'pricePerHourView')
            ,'product'
            ,'advanced'
            ,'high'
        );
    ...
    public static function pricePerHourView () {
        ...
        <div class="price-per-hour-wrap">
            <div class="price-per-hour-input">
                <input type="text" name="price-per-hour" value="<?php echo $price; ?>" />
            </div>
        </div>
        <?php
    }
