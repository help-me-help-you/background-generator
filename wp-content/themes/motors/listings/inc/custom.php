...
add_filter( 'manage_' . stm_listings_post_type() . '_posts_columns', 'set_listing_stock_number_column' );
function set_listing_stock_number_column($columns) {
...
add_action( 'manage_' . stm_listings_post_type() . '_posts_custom_column' , 'custom_stock_number_column', 10, 2 );
function custom_stock_number_column( $column, $post_id ) {
    switch ( $column ) {
...
function empty_cart( $passed, $product_id, $quantity, $variation_id = '', $variations= '' ) {
...
if(is_listing()) add_filter( 'woocommerce_add_to_cart_validation', 'empty_cart', 10, 5 );
...
function get_value_my_car_options() {
