...
<div class="etm-single-form">
    ...
    <input type="text" name="trade_in_subject" value="<?php echo $subject; ?>" class="full_width" />
    <input type="text" name="sell_a_car_subject" value="<?php echo $subjectSellACar; ?>" class="full_width" />
    <div class="lr-wrap">
        <div class="left">
            <?php
            $sc_arg = array(
