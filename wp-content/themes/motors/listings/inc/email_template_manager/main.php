...
wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/inc/email_template_manager/assets/js/bootstrap.js', 'jquery', STM_THEME_VERSION, true );
wp_enqueue_script( 'tab-bootstrap-js', get_template_directory_uri() . '/inc/email_template_manager/assets/js/tab.js', 'jquery', STM_THEME_VERSION, true );
wp_enqueue_script( 'etm-js', get_template_directory_uri() . '/inc/email_template_manager/assets/js/etm.js', 'jquery', STM_THEME_VERSION, true );
