            ...
            vc_map(array(
                ...
                'params' => array(
                    ...
                    array(
                        ...
                        'value' => get_value_my_car_options(),
                    ),
                    array(
                        'type' => 'textfield',
                        'heading' => __('Select prefix', 'motors'),
...
vc_add_shortcode_param('stm_autocomplete_vc_location', 'stm_autocomplete_vc_st_location', get_template_directory_uri() . '/inc/vc_extend/jquery-ui.min.js');
