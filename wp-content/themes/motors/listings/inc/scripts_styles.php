...
function stm_load_theme_ss() {
    ...
    wp_enqueue_style( 'stm-boostrap', get_theme_file_uri('/assets/css/bootstrap.min.css'), null, STM_THEME_VERSION, 'all' );

    wp_enqueue_style( 'stm-theme-font-awesome', get_theme_file_uri('/assets/css/font-awesome.min.css'), null, STM_THEME_VERSION, 'all' );

    wp_enqueue_style( 'stm-select2', get_theme_file_uri('/assets/css/select2.min.css'), null, STM_THEME_VERSION, 'all' );

    wp_enqueue_style('fancybox', get_theme_file_uri('/assets/css/jquery.fancybox.css'), array());
    ...
    if( get_theme_mod( 'site_style', 'site_style_default' ) != 'site_style_default' and is_dir( $upload_dir['basedir'] . '/stm_uploads' )  ) {
        ...
        if($layout == 'boats') {
            ...
            if(is_listing()) {
                ...
                wp_enqueue_style('stm-theme-style-listing-two-sass', get_theme_file_uri('/assets/css/listing_two/app.css'), null, STM_THEME_VERSION, 'all');
                wp_enqueue_style('stm-theme-style-listing-three-sass', get_theme_file_uri('/assets/css/listing_three/app.css'), null, STM_THEME_VERSION, 'all');
                wp_enqueue_style('stm-custom-scrollbar', get_theme_file_uri('/assets/css/listing/jquery.mCustomScrollbar.css'), null, STM_THEME_VERSION, 'all');
    ...
    if(stm_is_boats() || stm_is_dealer_two() or is_listing()) {
    ...
    wp_register_script( 'custom_scrollbar', get_theme_file_uri('/assets/js/jquery.mCustomScrollbar.concat.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );
    ...
    wp_enqueue_script( 'stm-jquerymigrate', get_theme_file_uri('/assets/js/jquery-migrate-1.2.1.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-bootstrap', get_theme_file_uri('/assets/js/bootstrap.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-isotope', get_theme_file_uri('/assets/js/isotope.pkgd.min.js'), array( 'jquery', 'imagesloaded' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-lazyload', get_theme_file_uri('/assets/js/jquery.lazyload.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-jquery-ui-core', get_theme_file_uri('/assets/js/jquery-ui.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-jquery-touch-punch', get_theme_file_uri('/assets/js/jquery.touch.punch.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-select2-js', get_theme_file_uri('/assets/js/select2.full.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script('fancybox', get_theme_file_uri('/assets/js/jquery.fancybox.pack.js'), array('jquery'), null, true);

    wp_enqueue_script( 'stm-uniform-js', get_theme_file_uri('/assets/js/jquery.uniform.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-datetimepicker-js', get_theme_file_uri('/assets/js/jquery.stmdatetimepicker.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-vivus', get_theme_file_uri('/assets/js/vivus.min.js'), array( 'jquery' ), STM_THEME_VERSION, false );

    wp_enqueue_script( 'jquery-cookie', get_theme_file_uri('/assets/js/jquery.cookie.js'), array( 'jquery' ), STM_THEME_VERSION, false );

    wp_enqueue_script( 'stm-typeahead', get_theme_file_uri('/assets/js/typeahead.jquery.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_enqueue_script( 'stm-theme-scripts', get_theme_file_uri('/assets/js/app.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    if(stm_is_magazine()) wp_enqueue_script( 'stm-magazine-theme-scripts', get_theme_file_uri('/assets/js/magazine_scripts.js'), array( 'jquery' ), STM_THEME_VERSION, true );

    wp_add_inline_script( 'stm-theme-scripts', get_theme_mod('footer_custom_scripts', '') );

    wp_register_script( 'stm-countUp.min.js', get_theme_file_uri('/assets/js/countUp.min.js'), array( 'jquery' ), STM_THEME_VERSION, true );
    ...
    if ( ! empty( $fixed_header ) and $fixed_header ) {
        wp_enqueue_script( 'stm-theme-scripts-header-scroll', get_theme_file_uri('/assets/js/app-header-scroll.js'), array( 'jquery' ), STM_THEME_VERSION, true );
    }

    if(stm_pricing_enabled()) {
        wp_enqueue_script( 'stm-theme-user-sidebar', get_theme_file_uri('/assets/js/app-user-sidebar.js'), array( 'jquery' ), STM_THEME_VERSION, true );
    ...
    if(stm_is_magazine()) {
        ...
        wp_enqueue_script( 'vue_min', get_theme_file_uri('/assets/js/vue.min.js'), array( 'stm-typeahead' ), STM_THEME_VERSION, false );
        wp_enqueue_script( 'vue_resource', get_theme_file_uri('/assets/js/vue-resource.js'), array( 'stm-typeahead' ), STM_THEME_VERSION, false );
        wp_enqueue_script( 'vue_app', get_theme_file_uri('/assets/js/vue-app.js'), array( 'stm-typeahead' ), STM_THEME_VERSION, false );
    }

    if(stm_is_rental()) {
        wp_enqueue_script( 'moment-localize', get_theme_file_uri('/assets/js/moment.min.js'), array( 'jquery' ), STM_THEME_VERSION, false );
    }

    $smooth_scroll = get_theme_mod( 'smooth_scroll', false );
    if( !empty($smooth_scroll) and $smooth_scroll) {
        wp_enqueue_script( 'stm-smooth-scroll', get_theme_file_uri('/assets/js/smoothScroll.js'), array( 'jquery' ), STM_THEME_VERSION, true );
    }
    ...
    if(stm_is_boats() || stm_is_dealer_two() || is_listing()) {
        ...
        wp_enqueue_script( 'stm-cascadingdropdown', get_theme_file_uri('/assets/js/jquery.cascadingdropdown.js'), array( 'jquery' ), STM_THEME_VERSION );
