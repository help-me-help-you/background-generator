...
motors_enqueue_scripts_styles('stm_listing_two_search');
            ...
            <div role="tabpanel" class="tab-pane fade in" id="stm_third_tab">
                        ...
                        if(!empty($third_tab_tax)) {
                            ...
                            foreach ($params as $k) {
                                ...
                                if($k == 'photo') {
                                    ...
                                    $html .= '<div class="file-wrap"><div class="input-file-holder"><span>' . __("Add Image") . '</span><i class="fa fa-plus"></i><input type="file"  name="' . $k . '" /></div><span class="error"></span></div>';
                                } else {
                ...
                <div class="btn-wrap">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12 stm-select-col">
                            <button id="vmc-btn" type="submit" class="heading-font"><?php echo $third_tab_label; ?><i class="fa fa-spinner"></i></button>
                            <?php
