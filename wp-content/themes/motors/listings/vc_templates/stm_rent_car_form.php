...
$dateTimeFormat = $dFormat . " " . get_option( 'time_format' );
        ...
        $(document).ready(function(){
            ...
            $('.stm-date-timepicker-start').stm_datetimepicker({
                ...
                onClose: function( ) {
                    if($('.stm-date-timepicker-start').val() != '' && $('.stm-date-timepicker-end').val() != '') {
                        checkDate(moment($('.stm-date-timepicker-start').val()).format(dateTimeFormatHide), moment($('.stm-date-timepicker-end').val()).format(dateTimeFormatHide));
                    }
            ...
            $('.stm-date-timepicker-end').stm_datetimepicker({
                ...
                onShow:function( ct ){
                    ...
                    var stmStartDate = $('.stm-date-timepicker-start').val() ? moment($('.stm-date-timepicker-start').val()).format(dateTimeFormatHide) : false;
            ...
            $('.clear-data').on('click', function (e) {
                ...
                jQuery.ajax({
                    ...
                    dataType: 'json',
                    context: this,
                    data: 'action=stm_ajax_clear_data',
