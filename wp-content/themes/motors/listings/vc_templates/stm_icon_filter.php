...
if (!empty($filter_selected)):
    ...
    <div class="stm_icon_filter_unit <?php echo esc_attr($css_class); ?>">
        ...
        <?php if (!empty($terms)): ?>
            <div id="<?php echo $randId; ?>" class="stm_listing_icon_filter stm_listing_icon_filter_<?php echo esc_attr($per_row); ?> text-<?php echo esc_attr($align); ?> filter_<?php echo $filter_selected;?>">
                           ...
                           title="<?php echo esc_attr($term->name); ?>">
                            <div class="inner">
                                ...
                                <div class="name"><?php echo esc_attr($term->name); ?>
                                    <?php if($asCarousel == 'no'): ?><span class="count">(<?php echo $term->count; ?>)</span><?php endif; ?></div>
                            </div>
                        </a>
                    <?php else: ?>
                    ...
                    <a href="<?php echo esc_url( stm_get_listing_archive_link( array( $filter_selected => $term->slug ), $multiply ) ); ?>"
                       ...
                       title="<?php echo esc_attr($term->name); ?>">
                        <div class="inner">
                            <div class="name">
                                <?php echo esc_attr($term->name); ?>
                                <?php if($asCarousel == 'no'): ?><span class="count">(<?php echo $term->count; ?>)</span><?php endif; ?>
                            </div>
                        </div>
                    </a>
                <?php endforeach; ?>
