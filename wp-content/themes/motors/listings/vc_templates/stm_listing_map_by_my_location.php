...
<div class="stm-inventory-map-wrap" style="height: <?php echo $mapHeight; ?>px;">
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function ($) {
        ...
        function init() {
            ...
            var data = 'ca_location=<?php echo $address; ?>&stm_lat=<?php echo $lat; ?>&stm_lng=<?php echo $lng;?>&max_search_radius=<?php echo $search_radius;?>';

            $.ajax({
                url: '<?php echo esc_url(admin_url('admin-ajax.php')); ?>',
                type: "GET",
                data: 'action=stm_ajax_get_cars_for_inventory_map&' + data,
                dataType: "json",
                success: function (msg) {
                    ...
                    markerCluster = new MarkerClusterer(map, markers, {maxZoom: 9, averageCenter: true, styles: [{url: '<?php echo $cluster_url_path; ?>', textColor: 'white', height: 60, width: 60, textSize: 20}]});
