...
motors_enqueue_scripts_styles('stm_image_filter_by_type');
...
<div class="stm-image-filter-wrap <?php echo esc_attr($css_class); ?>">
    ...
    <div id="<?php echo $randId;?>" class="stm-img-filter-container stm-img-<?php echo $row_number;?>">
        <?php
        if(is_array($items)) {
            $num = 0;
            $i = 0;
        ...
        ?>
            <div class="img-filter-item template-<?php echo $row_number . '-' . ($num%$row_number); ?>">
                ...
                <div class="body-type-data">
                    <div class="bt-title heading-font"><?php echo $term->name; ?></div>
                    <div class="bt-count normal_font"><?php echo $term->count . ' ' . esc_html__('cars', 'motors');?></div>
                </div>
            </div>
        <?php
