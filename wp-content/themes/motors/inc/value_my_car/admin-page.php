        ...
        <div class="vmc-action-wrap">
            <form action="<?php echo $_SERVER['REQUEST_URI']?>" method="get">
                ...
                <select name="post-status">
                    <option value="all" <?php if($postStatus == 'all') echo 'selected'; ?>>All</option>
                    <option value="pending" <?php if($postStatus == 'pending') echo 'selected'; ?>>Pending</option>
                    <option value="trash" <?php if($postStatus == 'trash') echo 'selected'; ?>>Trash</option>
                </select>
            ...
            <?php
                if($cars->have_posts()) {
                    while($cars->have_posts()) {
                        ...
                        $btns = '<button class="stm-vmc-reply-btn button-primary" data-id="' . get_the_ID() . '" data-title="' . get_the_title() . '" data-email="' . get_post_meta(get_the_ID(), 'vmc_email', true) .'" data-status="accepted">Reply</button>';
                        ...
                        else $btns .= '<button class="stm-vmc-action-btn button-secondary" data-id="' . get_the_ID() . '" data-title="' . get_the_title() . '" data-email="' . get_post_meta(get_the_ID(), 'vmc_email', true) .'" data-status="declined">Trash</button>';
