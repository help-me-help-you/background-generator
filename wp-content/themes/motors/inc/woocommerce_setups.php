...
function add_link_to_order ($item_id, $item, $order) {
...
add_action('woocommerce_order_item_line_item_html', 'add_link_to_order', 10, 3);


add_action('woocommerce_order_status_changed','make_featured_status_changed', 10, 3);
function make_featured_status_changed( $order_id, $oldStatus, $newStatus ) {
