...
<div class="review-top-content">
	...
	<div class="r-t-c-right">
		...
		if ( $show_title_box ) {
			$disable_overlay = '';
			?>
			<div class="stm-motors-review-header <?php echo esc_attr($alignment.$additional_classes.$disable_overlay); ?>" style="<?php echo $title_style; ?>">
				<div class="left">
			...
			<div class="stm-review-video">
				<?php echo $videoImgPrev; ?>
				<div id="review-play-btn" class="play-btn">
					<i class="rev-icon-review_play"></i>
				</div>
				<div class="iframeWrap">
					<iframe width="100%" height="100%" src="<?php echo $videoSrc; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
				</div>
			</div>
		<?php
		}

		echo $motorsReviewSCE->get_the_review_subcontent();
		?>
	</div>
</div>