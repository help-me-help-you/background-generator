 ...
 * @access public
 */
class ButterBean_Event_Control_Checkbox_Repeater extends ButterBean_Event_Control {
    ...
    public function __construct( $manager, $name, $args = array() ) {
        ...
        $this->l10n = wp_parse_args(
            $this->l10n,
            array(
                'add_feature'      => esc_html__( 'Add new feature',         'stm_motors_events' ),
                'add'      => esc_html__( 'Add',         'stm_motors_events' ),
                'all'      => esc_html__( 'Show all',         'stm_motors_events' ),
                'remove'      => esc_html__( 'Delete',      'stm_motors_events' ),
            )
        );
    }
