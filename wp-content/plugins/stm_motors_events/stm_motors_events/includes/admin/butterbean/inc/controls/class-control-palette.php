 ...
 * @access public
 */
class ButterBean_Event_Control_Palette extends ButterBean_Event_Control {
	...
	public function to_json() {
		...
		foreach ( $this->choices as $choice => $palette ) {
			$this->choices[ $choice ]['colors'] = array_map( 'butterbean_event_maybe_hash_hex_color', $palette['colors'] );
