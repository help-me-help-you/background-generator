 ...
 * @access public
 */
class ButterBean_Event_Control_Datetime extends ButterBean_Event_Control {
	...
	public function to_json() {
		...
		$this->json['year'] = array(
			'value' => esc_attr( $year ),
			'label' => esc_html__( 'Year', 'stm_motors_events' ),
		...
		$this->json['month'] = array(
			...
			'label'   => esc_html__( 'Month', 'stm_motors_events' ),
			'choices' => array(
				array(
					'num'   => '',
					'label' => ''
		...
		$this->json['day'] = array(
			...
			'label' => esc_html__( 'Day', 'stm_motors_events' ),
		...
		$this->json['hour'] = array(
			...
			'label' => esc_html__( 'Hour', 'stm_motors_events' ),
		...
		$this->json['minute'] = array(
			...
			'label' => esc_html__( 'Minute', 'stm_motors_events' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
		...
		$this->json['second'] = array(
			...
			'label' => esc_html__( 'Second', 'stm_motors_events' ),
			'attr'  => 'placeholder="00" size="2" maxlength="2" autocomplete="off"'
		);
	}
}
