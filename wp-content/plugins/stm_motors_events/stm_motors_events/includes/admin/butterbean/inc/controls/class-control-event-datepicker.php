 ...
 * @access public
 */
class ButterBean_Event_Control_Event_Datepicker extends ButterBean_Event_Control {
	...
	public function enqueue() {
        wp_enqueue_style('stm_admin_butterbean_datepicker',
            STM_EVENTS_URL . '/assets/css/jquery-ui.min.css',
            false,
            1,
            false);
	}
	...
	public function get_attr() {
		...
		$attr['class']              = 'butterbean-event-datepicker';
		$attr['type']               = 'text';
