 ...
 * @return bool|int
 */
function butterbean_event_validate_boolean( $value ) {
 ...
 * @return string
 */
function butterbean_event_sanitize_hex_color( $color ) {
 ...
 * @return string
 */
function butterbean_event_sanitize_hex_color_no_hash( $color ) {
	...
	return butterbean_event_sanitize_hex_color( '#' . $color ) ? $color : null;
}
 ...
 * @return string
 */
function butterbean_event_maybe_hash_hex_color( $color ) {

	if ( function_exists( 'maybe_hash_hex_color' ) )
		return maybe_hash_hex_color( $color );

	if ( $unhashed = butterbean_event_sanitize_hex_color_no_hash( $color ) )
		return '#' . $unhashed;
 ...
 * @return void
 */
function butterbean_event_get_manager_template( $slug = '' ) {
	butterbean_event_get_template( 'manager', $slug );
}
 ...
 * @return void
 */
function butterbean_event_get_nav_template( $slug = '' ) {
	butterbean_event_get_template( 'nav', $slug );
}
 ...
 * @return void
 */
function butterbean_event_get_section_template( $slug = '' ) {
	butterbean_event_get_template( 'section', $slug );
}
 ...
 * @return void
 */
function butterbean_event_get_control_template( $slug = '' ) {
	butterbean_event_get_template( 'control', $slug );
}
 ...
 * @return void
 */
function butterbean_event_get_template( $name, $slug = '' ) {
	...
	if ( ! $located ) {
		...
		foreach ( $templates as $template ) {
			...
			if ( file_exists( butterbeanEvent()->tmpl_path . $template ) ) {
				$located = butterbeanEvent()->tmpl_path . $template;
				break;
			}
		}
	}
