 ...
 * @access public
 */
class ButterBean_Event_Control_Image extends ButterBean_Event_Control {
	...
	public function __construct( $manager, $name, $args = array() ) {
		...
		$this->l10n = wp_parse_args(
			...
			array(
				...
				'set'         => esc_html__( 'Set as image',      'stm_motors_events' ),
				'choose'      => esc_html__( 'Choose image',      'stm_motors_events' ),
				'change'      => esc_html__( 'Change image',      'stm_motors_events' ),
				'remove'      => esc_html__( 'Remove image',      'stm_motors_events' ),
				'placeholder' => esc_html__( 'No image selected', 'stm_motors_events' )
			)
		);
	}
