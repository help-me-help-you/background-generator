 ...
 * @access public
 */
class ButterBean_Event_Control_Gallery extends ButterBean_Event_Control {
    ...
    public function __construct( $manager, $name, $args = array() ) {
        ...
        $this->l10n = wp_parse_args(
            $this->l10n,
            array(
                'upload' => esc_html__('Add image', 'stm_motors_events'),
                'set' => esc_html__('Add images', 'stm_motors_events'),
                'choose' => esc_html__('Choose images', 'stm_motors_events'),
                'change' => esc_html__('Add images', 'stm_motors_events'),
                'remove' => esc_html__('Remove all', 'stm_motors_events'),
                'drop' => esc_html__('Drag and drop featured image here', 'stm_motors_events'),
                'placeholder' => esc_html__('No images selected', 'stm_motors_events')
            )
        );
    }
